	...
	<tr>
		...
		<div id="content-table-inner">
			...
			foreach ($players as $key => $val) {
				...
				$query = "SELECT * FROM main WHERE name = '".$val['player_']."' ORDER BY lastupdate DESC LIMIT 1"; 
				...
				while ($row=mysql_fetch_array($res)) {
					...
					echo "<tr>
						<td align=\"center\"><a href=\"index.php?view=info&show=1&id=".$row['uid']."&cid=".$row['id']."\">".$val['player_']."</a></td>
